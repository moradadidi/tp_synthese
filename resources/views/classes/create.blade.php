...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-xl mx-auto bg-white dark:bg-gray-800 shadow-lg p-6 rounded-lg">
        <h2 class="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Ajouter une nouvelle classe</h2>
        <form method="POST" action="{{ route('classes.store') }}">
            @csrf
            <div class="mb-4">
                <label for="libelle" class="block text-gray-700 dark:text-gray-300">Libellé</label>
                <input type="text" name="libelle" id="libelle" class="w-full mt-1 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="nombreMax" id="nombreMax" class="w-full mt-1 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
            ...
            <div class="mb-4">
                ...
                <select name="idformation" id="idformation" class="w-full mt-1 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
                    ...
                    @foreach($formations as $formation)
                        <option value="{{ $formation->idf }}">{{ $formation->titre }}</option>
                    @endforeach
                </select>
